...
label search_loop_y
    ...
    label search_loop_x
        ...
        jp | eq | i2 r2 '\n' search_loop_x_continue
        jp | eq | i2 r2 '.' search_loop_x_continue
        sub | i2 r2 '0' ovf
        jp | leq | i2 ovf '9' search_loop_x_continue
        ...
        jp | eq | i2 n_found 0 break_subloop
        ...
        label add_loop
            ...
            call(parse_number)
            add r2 ans ans
            sub | i2 n_found 1 n_found
            jp | neq | i2 n_found 0 add_loop
